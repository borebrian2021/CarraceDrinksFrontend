...
function DrinkBody(){
    return(
        <motion.div initial={{x:1500}} animate={{x:0}} transition={{duration:0.8}} className="container-fluid mt-5 hundred">
...
<motion.img initial={{x:1500}} animate={{x:0}} transition={{duration:0.8, delay:1.6, stiffness:200,type: "spring"}} src="../../images/onWelcome.png" className="logoBig"/>
<motion.p className="p_white" initial={{x:1500}} animate={{x:0}} transition={{duration:0.8, delay:1.9, stiffness:200,type: "spring"}} >Carrace Drinks Trusted by millions to discover and buy the right wine every time.</motion.p>
<motion.p className="p_white" initial={{x:1500}} animate={{x:0}} transition={{duration:0.8, delay:1.9, stiffness:200,type: "spring"}} >Carrace Drinks Trusted by millions to discover and buy the right wine every time.</motion.p>
<motion.Button className="getStarted" initial={{x:1500}} animate={{x:0}} transition={{duration:0.8, delay:2.1, stiffness:200,type: "spring"}}>Get Started</motion.Button>
