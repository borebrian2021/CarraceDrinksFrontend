    ...
    return (
        <motion.div class="row bg_dark2" variants={variants_} initial="hidden" animate="visible" exit="exit">
            <div class="col-12 col-lg-12 col-md-12 col-sm-12 p-5 center_first">
                ...
                <motion.Button className="getStarted" initial={{ x: 1500 }} animate={{ x: 0 }} transition={{ duration: 0.8, delay: 2, stiffness: 200, type: "spring" }} onClick={goToLogin}>Sin In</motion.Button>
            </div>
