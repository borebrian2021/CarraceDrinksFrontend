...
<motion.h3 className="p_white labelTitle" initial={{x:1500}} animate={{x:0}} transition={{duration:0.8, delay:1.6, stiffness:200,type: "spring"}} >Lanson Noble Cuvee</motion.h3>
