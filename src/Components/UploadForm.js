        ...
        <motion.div variants={variants_} initial="hidden" exit="exit" animate="visible" className="ddrinksDetails pt-4 ">
            <form class="row bg_dark2" onSubmit={handleSubmit}>
                ...
                <div class="col-12 col-lg-6 col-md-6 col-sm-12 p-5  text-left">
                    ...
                    <motion.input required initial={{ x: -1500 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.3, stiffness: 120, type: "spring" }} value={description} type="text" placeholder='Enter description...' onChange={handleSetDescription} class="form-control m-2" />
