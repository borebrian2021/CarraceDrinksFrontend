        ...
        <motion.div variants={variants_} initial="hidden" exit="exit" animate="visible" className="ddrinksDetails pt-4 ">
            <form class="row bg_dark2" onSubmit={handleSubmit}>
                ...
                <div class="col-12 col-lg-6 col-md-6 col-sm-12 p-5  text-left">
                    ...
                    <motion.input value={name} initial={{ x: -1500 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 0.3, stiffness: 120, type: "spring" }} onChange={handleSetName} type="text" placeholder='Enter Brand name...' class="form-control m-2" />
                    ...
                    <motion.input initial={{ x: -1500 }} value={capacity} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 0.5, stiffness: 120, type: "spring" }} onChange={handleSetCapacity} type="text" placeholder='Enter capacity...' class="form-control m-2" />
                    ...
                    <motion.select initial={{ x: -1500 }}  onChange={handleSetCategory} value={category} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 0.7, stiffness: 120, type: "spring" }}  className="form-control m-2">
                    ...
                    <motion.input value={price} initial={{ x: -1500 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 0.9, stiffness: 120, type: "spring" }} placeholder='Enter price...'  class="form-control m-2" onChange={handleSetPrice} />
                    ...
                    <motion.input initial={{ x: -1500 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.1, stiffness: 120, type: "spring" }} value={percentage} placeholder='Enter alcohol percentage...' onChange={handleSetPercentage} class="form-control m-2" />
                    ...
                    <motion.input initial={{ x: -1500 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.3, stiffness: 120, type: "spring" }} value={description} placeholder='Enter description...' onChange={handleSetDescription} class="form-control m-2" />
                    ...
                    <motion.input initial={{ x: -1500 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.5, stiffness: 120, type: "spring" }} value={image} placeholder='Enter image URL...' onChange={handleSetImage} class="form-control m-2" />
                    ...
                    <motion.input initial={{ x: -1500 }} animate={{ x: 0 }} transition={{ duration: 0.3, delay: 1.5, stiffness: 120, type: "spring" }} value={cog} placeholder='Enter country of origin...' onChange={handleSetCog} class="form-control m-2" />
